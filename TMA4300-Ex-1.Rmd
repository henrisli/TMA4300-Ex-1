...
```{r, echo = T, eval = T, out.width = "50%", fig.align = "center"}
#As specified above, gamma2 samples using rejection sampling for alpha < 1
# and the ratio of uniforms method for alpha > 1. If alpha = 1 we sample
...
```{r, echo = T, eval = T}
library(MCMCpack)
#A function for fetching only the samples, not number of iterations
...
#Sample the alphas from the exponentila distribution
